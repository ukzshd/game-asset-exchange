...
import { isPublishedProduct, withMarketplacePresentation } from '@/lib/marketplace';
...
export async function GET(_request, { params }) {
    try {
        ...
        return NextResponse.json({
            product: withMarketplacePresentation(product),
            related: (related || []).map(withMarketplacePresentation),
        });
    } catch (error) {
